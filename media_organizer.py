...
def organize_media(src_dir):
    ...
    for dir_path, dir_names, file_names in tqdm(os.walk(src_dir), position=0, desc="i", leave=False, colour='green'):
        for file in tqdm(file_names, position=1, desc="j", leave=False, colour='red'):
